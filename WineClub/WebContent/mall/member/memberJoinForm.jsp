...
th { background: #a6c8e9; }
table span { font-size: 0.8em; }
.addr_row { height: 100px; }
.addr_row input { margin: 2px 0;}
#btn_chk_id { width: 100px; height: 28px; border: none; background: #b191bd;
		color: white; font-size: 12px; cursor: pointer; border-radius: 3px; 
		margin-left: 10px; }
#btn_address { width: 100px; height: 28px; border: none; background: #54d6c1;
		color: white; font-size: 12px; cursor: pointer; border-radius: 3px; }
/* 하단 - 가입, 취소 버튼 */
...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		let form = document.joinForm; // 폼 받는법
		...
		// 회원 가입 페이지의 전체 내용 입력 유무에 따른 유효성 검사와 페이지 이동
...
<div id="container">
	...
	<div class="t_title">WineClub 회원가입</div>
		...
		<table>
			<tr>
				...
				<td>
					...
					<input type="button" value="ID 중복 확인" id="btn_chk_id"><br>
					<span id="chk_id"></span>
				</td>
			</tr>
			<tr>
