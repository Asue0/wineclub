...
.duy_detail { width: 100%; }
/* d1 - 상품 상세 보기 */
.d1 { margin-bottom: 50px; }
.d1 .t1 { width: 90%; boarder: 1px solid gray; border-collapse: collapse; margin: 0 auto; font-size: 0.9em; 
...
.d1 .t1 tr:last-child th { font-weight: normal; }
...
.d2 .t2 { width: 90%; boarder: 1px solid gray; border-collapse: collapse; margin: 0 auto; font-size: 0.9em; 
border-left: none; border-right: none; clear: both; }
			...
			<table class="t1">
				...
				<tr>
					...
					<td width="8%" class="left">
						<span class="s2"><a href="../shopping/shopContent.jsp?product_id=<%=buy.getProduct_id()%>"><img src="/images_wineclub/<%=buy.getProduct_image() %>" width="60" height="90"></a></span>
					</td>
					<td width="29%" class="left">
						<span class="s3"><a href="../shopping/shopContent.jsp?product_id=<%=buy.getProduct_id()%>"><%=buy.getProduct_name() %></a></span>
					</td>
					...
					<td class="center"><span class="s6"><%=df.format(tot1) %></span></td>
