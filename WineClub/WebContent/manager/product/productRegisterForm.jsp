...
table { width: 100%; border: 1px solid #2f9e77; border-collapse: collapse; 
	border-top: 3px solid #2f9e77; border-bottom: 3px solid #2f9e77;
...
/* 하단 - 버튼 */
select { height: 25px; }
input::file-selector-button { width: 90px; height: 28px; background: #2f9e77; color: #fff;
...
.btns input:nth-child(1):hover { border: 2px solid #2f9e77; background: #fff;
	color: #2f9e77; font-weight: bold; cursor: pointer; }
</style>
<script>
...
<div id="container">
	...
	<form action="productRegisterPro.jsp" method="post" name="registerForm" enctype="multipart/form-data">
		<table>
			...
			<tr>
				<th>와인 품종</th>
				<td><input type="text" name="wine_variety" size="56"></td>
			</tr>
			<tr>
				<th>알코올 도수</th>
				<td><input type="text" name="alcoholicity" size="10">%</td>
			</tr>
			<tr>
				<th>와인 양</th>
				<td><input type="number" name="amount" min="0">ml</td>
			</tr>
			<tr>
				<th>상품 이미지</th>
