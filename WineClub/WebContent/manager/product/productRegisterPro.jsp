...
/* 
자바빈을 이용할 수 없다
-> productRegisterForm에서 폼이 이미지 파일을 업로드 받기 위한
파일 업로드 폼이기 때문에
...
String realFolder = "d:/images_wineclub"; // 파일이 저장될 폴더
...
try {
	...
	// 만들어진 MultipartRequest를 사용해 폼에서 넘어오는 9개의 필드 값을 획득 (이미지, 상품 내용 이미지는 위에서 이미 따로 처리함)
	// 제외) product_id, reg_date
