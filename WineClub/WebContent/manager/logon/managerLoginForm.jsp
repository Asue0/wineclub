...
/* 상단 - 메인, 서브 타이틀 */
.m_title { font-family: 'Lobster', cursive; font-size: 3em; text-align: center; font-weight: bold; }
...
.b_box input[type='text'], .b_box input[type='password'] { height: 30px; 
...
.b_box input[type='password'] { background: url('../../icons/login_pwd.png') no-repeat;
	background-size: 25px; background-position: left center;}
.c_box { margin: 10px; }
.c_box input[type="button"] { width: 280px; height: 45px; border:none; background:#5e869c;
	color: #fff; font-weitgh: bold; font-size: 1.03em; }
...
<body>
<div id="container">
	<div class="m_title"><a href="#">WINE CLUB</a></div>
